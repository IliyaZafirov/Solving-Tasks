...
// of operations and the number of times they need to be repeated to bring them to the desired thickness.
...
function radioCrystals(crystal) {


    let targetThickness = crystal.shift();
    
    for (let chunk of crystal) {
        console.log(chunk);
    }
